...
import { getCruiseById } from "@/lib/data/cruises"
    ...
    return (
      <main className="min-h-screen bg-background">
        ...
        <div className="pt-20 md:pt-24 container max-w-[1200px] mx-auto px-4 py-20 text-center">
          ...
          <p className="text-muted-foreground">The cruise you are looking for does not exist or has been removed.</p>
        </div>
        <Footer />
      </main>
    )
        ...
        <div className="container max-w-[1200px] mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="flex-1">
              <CruiseDetail cruiseId={id} initialData={cruise} />
              <CruiseItinerary />
              <CruiseReviews />
            </div>
