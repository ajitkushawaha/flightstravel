                  ...
                  setMessages((prev) => {
                    ...
                    if (last && last.role === "assistant") {
                      updated[updated.length - 1] = {
                        ...
                        recommendations,
                        type: recommendations.length > 0 ? "recommendation" : "text",
                      }
                    }
                    return updated
                  })
  ...
  useEffect(() => {
    ...
    if (initialPrompt) {
      ...
      setMessages([
        {
          role: "assistant",
          content: "Hi! Welcome to iCruise Egypt. I’d love to help you find a Nile cruise that feels just right. What kind of experience are you hoping for—luxury, mid-range, or budget?",
        },
      ])
    }
