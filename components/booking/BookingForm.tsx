...
interface BookingFormProps {
    itemType: 'CRUISE' | 'HOTEL' | 'FLIGHT' | 'TOUR' | 'TRANSFER';
    itemId: string;
    itemName: string;
    price: number;
}

export function BookingForm({ itemType, itemId, itemName, price }: BookingFormProps) {
                ...
                handler: async function (response: any) {
                    ...
                    if (verifyData.success) {
                        ...
                        toast.success('Payment Successful!', {
                            description: `Your booking for ${itemName} is confirmed. Confirmation code: ${verifyData.confirmationCode}`,
                        });
                        form.reset();
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Request a booking for <span className="font-semibold text-blue-900">{itemName}</span>.
